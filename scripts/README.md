# Scripts (authored for this lab)

Built on top of the **colibrì** engine by [JustVugg](https://github.com/JustVugg/colibri) (Apache-2.0).  
These harness files are separate lab tooling.
...
export GLM_BIN=/path/to/colibri/c/glm          # build from JustVugg/colibri (post-PR #199)
...
Requires: Python 3, `tokenizers`, SCORE-capable `glm` binary with optional `CACHE_ROUTE`.
